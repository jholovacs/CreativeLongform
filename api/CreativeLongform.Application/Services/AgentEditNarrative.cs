...
internal static class AgentEditNarrative
{
    ...
    private static string BuildThinkingSubject(AgentEditLoopState state)
    {
        ...
        return state.LastToolName switch
        {
            ...
            "run_quality_check" => "the quality results and craft fixes still needed",
            "check_scene_brief" => "the scene beat checklist",
            "check_word_budget" => "whether the draft meets the word target",
            "break_up_scene" => "expanding the scene in Writer beats",
